...
public class CatService extends Handler implements AppInterface {
    ...
    private CatService(CommandsInterface ci, UiccCardApplication ca, IccRecords ir,
        ...
        mCmdIf.setOnStkCallCtrl(this, MSG_ID_CALL_CTRL, null);
        mIccRecords = ir;
        mUiccApplication = ca;
    ...
    public static CatService getInstance(CommandsInterface ci,
        ...
        synchronized (sInstanceLock) {
            String cmd = null;
            //MTK-START [mtk80950][121110][ALPS00XXXXXX] add for Gemini+ the 3rd card and the 4th card
            if ((PhoneConstants.SIM_ID_1 == slotId && sInstanceSim1 == null)
                || (PhoneConstants.SIM_ID_2 == slotId && sInstanceSim2 == null)
                || (PhoneConstants.SIM_ID_3 == slotId && sInstanceSim3 == null)
                || (PhoneConstants.SIM_ID_4 == slotId && sInstanceSim4 == null)) {
                //MTK-END [mtk80950][121110][ALPS00XXXXXX] add for Gemini+ the 3rd card and the 4th card
                ...
                tempInstance = new CatService(ci, ca, ir, context, fh, ic, slotId);
                //MTK-START [mtk80950][121110][ALPS00XXXXXX] add for Gemini+ the 3rd card and the 4th card
                ...
                } else { //(PhoneConstants.SIM_ID_4 == slotId)
...
*/
    ...
    private void handleDBHandler(int sim_id)
    {
        ...
        if (sim_id == PhoneConstants.SIM_ID_1) {
            saveCmdToPreference(mContext, sInst1, null);
        } else if (sim_id == PhoneConstants.SIM_ID_2) {
            saveCmdToPreference(mContext, sInst2, null);
        } else if (sim_id == PhoneConstants.SIM_ID_3) {
            saveCmdToPreference(mContext, sInst3, null);
        } else if (sim_id == PhoneConstants.SIM_ID_4) {
    ...
    private ContentObserver mPowerOnSequenceObserver = new ContentObserver(this) {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (false == SystemProperties.get("ro.mtk_bsp_package").equals("1")) {
                 ...
                 */
                 CatLog.d(this, "onChange(" + selfChange + ", " + uri + "): stub!");
            }
    ...
    private void registerPowerOnSequenceObserver() {
        ...
        */
        CatLog.d(this, "registerPowerOnSequenceObserver: stub!");
    }
    ...
    private void resetPowerOnSequenceFlag() {
        ...
        */
        CatLog.d(this, "resetPowerOnSequence: stub!");
    }
